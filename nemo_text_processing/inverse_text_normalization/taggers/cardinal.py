...
class CardinalFst(GraphFst):
    ...
    def __init__(self):
        ...
        graph_thousands = pynini.union(
            graph_hundred_component_at_least_one_none_zero_digit + delete_space + graph_thousands_end,
            pynutil.insert("000", weight=0.1),
        )

        graph_million = pynini.union(
            graph_hundred_component_at_least_one_none_zero_digit + delete_space + graph_million_end,
            pynutil.insert("000", weight=0.1),
        )

        graph_billion = pynini.union(
            graph_hundred_component_at_least_one_none_zero_digit + delete_space + graph_billion_end,
            pynutil.insert("000", weight=0.1),
        )
        ...
        optional_minus_graph = pynini.closure(
            pynutil.insert("negative: ") + pynini.union(pynini.cross("âm", "\"-\""), pynini.cross("âm", "\"-\"")) + NEMO_SPACE, 0, 1
        )
