...
class DecimalFst(GraphFst):
    ...
    def __init__(self):
        ...
        optionl_sign = pynini.closure(pynini.cross("negative: \"true\"", "-") + delete_space_optional, 0, 1)
        integer = (
        ...
        optional_quantity = pynini.closure(pynutil.insert(" ") + quantity + delete_space_optional, 0, 1)
